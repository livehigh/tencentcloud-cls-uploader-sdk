(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('axios'), require('crypto-js')) :
    typeof define === 'function' && define.amd ? define(['axios', 'crypto-js'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ClsClient = factory(global.axios, global.crypto));
})(this, (function (axios, crypto) { 'use strict';
    ...
    function sign(opt) {
        ...
        // 签名有效起止时间
        const now = Math.floor(util$5.getSkewTime(opt.systemClockOffset) / 1000) - 1;
        let exp = now;
